...
namespace GNetwork
{
	...
	public struct FloatUnion
	{
		...
		public static float BytesToFloat( List<byte> bytes, int offset )
		{
		...
		public static void AddBytes( List<byte> bytes, float value )
		{
			FloatUnion floatUnion = new FloatUnion { Value = value };
